...
The region \textcircled{b} on Figure~\ref{fig:interface} shows a class diagram that is generated as the engineer performs the refactorings in KDM model, i.e., changes are reproduced on the fly in a class diagram.
